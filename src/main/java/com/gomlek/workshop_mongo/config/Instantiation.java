...
import com.gomlek.workshop_mongo.dto.AuthorDTO;
import com.gomlek.workshop_mongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post2 = new Post(null, sdf.parse("23/12/2018"), "Bom dia!", "Acordei Feliz Hoje !", new AuthorDTO(maria));
